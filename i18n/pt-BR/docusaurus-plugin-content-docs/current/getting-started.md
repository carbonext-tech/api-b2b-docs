...
O procedimento a seguir equivale ao ato de digitar seu usuário e senha no site e gerar um certificado que permite acesso aos seus dados, da mesma forma a integração com seu sistema estará ligada à autenticação e nenhum endpoint responderá sem o uso do **token**.
